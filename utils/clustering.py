...
def clustering(data, method, n_clusters=5, eps=0.01, min_cluster_size=100, knn=1000):
    """
        ...
        Args:
            ...
            eps (float, optional): Epsilon parameter for DBSCAN, specifies how close points should be to each other to be considered a part of a cluster. Default is 0.01.
            min_cluster_size (int, optional): The minimum number of samples in a neighborhood for a point to be considered as a core point in DBSCAN. Default is 100.
            knn (int, optional): The number of nearest neighbors to consider for FHC_LPD. Default is 1000.
        Returns:
            tuple: A tuple containing the array of cluster labels and the number of clusters detected. The array assigns each observation in the dataset to a cluster.
