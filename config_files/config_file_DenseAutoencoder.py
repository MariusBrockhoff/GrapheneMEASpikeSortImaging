...
class Config_DenseAutoencoder(object):
    ...
    def __init__(self):
        ...
        # Model Type
        self.MODEL_TYPE = "DenseAutoencoder"  # Type of the model

        # Input Sequence Length
        self.SEQ_LEN = 63  # Length of the input sequences

        # Latent Space Length
        self.LATENT_LEN = 10  # Size of the latent representation

        # Layer Dimensions
        self.DIMS = [self.SEQ_LEN, 500, 500, 2000, self.LATENT_LEN]  # Dimensions of the layers in the autoencoder

        # Activation Function
        self.ACT = "relu"  # Activation function for the layers
